...
const Footer = () => {
  ...
  return (
    <footer className="relative text-slate-300 pt-20 pb-8 border-t  border-slate-200 overflow-hidden">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-secondary/99 skew-x-12 translate-x-20 pointer-events-none overflow-hidden" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-3">
              <h4 className="text-secondary text-lg font-bold mb-6 flex items-center gap-2">
              ...
              <ul className="space-y-3">
                {services.map((service, idx) => (
                  <li key={idx}>
                    <Link
                      href={service.path}
                      className="group flex items-center gap-2 text-sm text-slate-400 transition-colors hover:text-secondary"
                    >
            ...
            <div className="lg:col-span-3">
              <div className="bg-secondary border border-white  rounded-3xl p-6 shadow-xl relative overflow-hidden group">
                ...
                <p className="text-white text-sm mb-6 relative z-10">
                ...
                <a
                  href="tel:0405133761"
                  className="flex items-center justify-center gap-3 w-full bg-white text-primary py-4 px-4 rounded-xl font-bold transition-transform duration-300 hover:scale-105 shadow-lg shadow-secondary/25 relative z-10"
                >
                  <LuPhoneCall className="text-xl animate-pulse" />
                  0405 133 761
                </a>

                <div className="mt-4 flex items-center gap-2 text-xs text-primary font-medium relative z-10">
                  <LuShieldCheck className="text-white text-base shrink-0" />
